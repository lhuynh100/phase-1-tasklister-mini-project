document.addEventListener("DOMContentLoaded", () => {
  ...
  const taskList = [
    {id: 1, description: 'do the laundry', priority: 'medium', done: false},
    {id: 1, description: 'wash the car', priority: 'medium', done: false},
    {id: 1, description: 'meal prep', priority: 'medium', done: false},
  ];
